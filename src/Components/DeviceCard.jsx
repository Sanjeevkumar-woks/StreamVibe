const DeviceCard = ({ iconClass, deviceName, description }) => {
  return (
    <div className="flex flex-col justify-center items-center w-[80%] text-center bg-gradient-to-r from-black to-red-600 p-4 rounded-md shadow-md hover:shadow-white">
